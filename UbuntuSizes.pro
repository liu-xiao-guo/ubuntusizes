...
UBUNTU_TRANSLATION_DOMAIN="ubuntusizes.liu-xiao-guo"
...
aptest.commands = bash $$PWD/UbuntuSizes/tests/autopilot/run
aptest.depends  = sub-UbuntuSizes

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/UbuntuSizes/tests/unit
unittest.depends  = sub-UbuntuSizes
